...
@Service
public class DepositRepository implements DepositService {
    ...
    @Override
    public TransactionResponseDTO deposit(Transaction deposit, String depositAccountId) {
        ...
        try {
            ResponseEntity<TransactionResponseDTO> response = restTemplate
                    .exchange(basePath + "/deposits/" + depositAccountId + "/deposit-transactions", HttpMethod.POST, httpEntity, TransactionResponseDTO.class);
